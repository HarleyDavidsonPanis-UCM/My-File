...
public class Main {
    public static void main(String[] args) {
        ...
        RegularEmployee reg = new RegularEmployee(reFname, reLname, reId, rePos, reDept, reHours, reRate, reBonus);
        ...
        double ceAmount = sc.nextDouble();
        System.out.print("Contract Months: ");
        int ceMonths = sc.nextInt();
        sc.nextLine();

        ContractualEmployee con = new ContractualEmployee(ceFname, ceLname, ceId, cePos, ceDept, 0, 0, ceAmount, ceMonths);
